...
class AboutIteration < EdgeCase::Koan
  ...
  #use break to split up an array for particular methods
  ...
  def test_select_selects_certain_items_from_an_array
    ...
    assert_equal [1,3,5], more_even_numbers
  end
  ...
  def test_inject_will_blow_your_mind
    ...
    #takes each element of the array and performs the behavior described
  ...
  #We don't want to get used to passing open files into variables, security issue, weak code
  #
