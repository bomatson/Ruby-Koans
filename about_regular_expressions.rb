...
# so /thing/ will look for str "thing"
  # ------------------------------------------------------------------
  ...
  #is a or b there, z was not so it didn't print it
  ...
  #
  # Why?
  #Because they return too many variables 
  ...
  # why does this happen? does the space break the string?
  # ------------------------------------------------------------------
  ...
  #alteration means 'or' whereas a character class is 'and'
...
# this seems like a valuable find, using scan with \w+ will put the words in a array

  def test_sub_is_like_find_and_replace
    assert_equal "one t-three", "one two-three".sub(/(t\w*)/) { $1[0, 1] }
  end
  
  # http://stackoverflow.com/questions/6169391/ruby-koans-regex-and-sub-dont-understand-reason-behind-answer
